...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1687605015ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=todoapp&table=tb_todos">`todoapp`.`tb_todos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=todoapp&table=tb_user">`todoapp`.`tb_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mourad&table=produit">`mourad`.`produit`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mourad&table=journal">`mourad`.`journal`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mourad&table=stock">`mourad`.`stock`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mourad&table=fournisseur">`mourad`.`fournisseur`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mourad&table=users">`mourad`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mourad&table=agent">`mourad`.`agent`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mourad&table=agprd">`mourad`.`agprd`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oswa_inv&table=users">`oswa_inv`.`users`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2943213678442c6542345e7a587d3249">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="todoapp" targettable="tb_todos">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `tb_todos`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="todoapp" targettable="tb_todos">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `tb_todos`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="todoapp" targettable="tb_user">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `tb_user`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="todoapp" targettable="tb_user">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT id FROM `tb_user` where username = &quot;Mourad&quot;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="todoapp" targettable="tb_user">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">select todo ,status
from tb_user t, tb_todos b
where t.Id = b.idu
and t.username = &#039;Mourad&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="todoapp" targettable="tb_user">
                            <div class="action_content">
